public class WikiParser{
	...
	public String parser(String set){
	...
	private String get(){ //returns the next char as a String. Position vector moves on
	...
	private void next(){	//changes vector to point at next char
